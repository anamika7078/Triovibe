            ...
            >
                <div className="bg-white rounded-2xl shadow-2xl p-8">
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-3xl font-black text-slate-900 mb-2">Create Admin Account</h1>
                        <p className="text-slate-600 font-medium">Sign up to access the admin panel</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            {formData.confirmPassword && formData.password === formData.confirmPassword && (
                                <div className="mt-2 flex items-center gap-2 text-teal-600 text-sm font-medium">
                                    <CheckCircle size={16} />
                                    Passwords match
                                </div>
                            )}
